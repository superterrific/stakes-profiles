...
// data - winning favs
	...
	dataTable2.addRows([
		...
		['',  8, '27.6% Winning Favs', 'Winning Favorites: 8', 21, '', 'Favorites not Winning: 21'],
...
// data - running styles
	...
	dataTable3.addColumn({type:'string', role:'annotation'});
	dataTable3.addRows([
		['',  2, '7.1% Deep Closer', 6, '21.4% Off the Pace', 16, '57.1% Stalker/Presser', 4, '14.2% Speed'],
  ]);
...
// data - prior race
	...
	dataTable4.addRows([
		...
		['',  28, '96.6% In the Money Prior Race', 'In the Money Prior Race: 28',  1, '', 'Out of the Money Prior Race: 1'],
  ]);
...
// options - last track track
	...
	colors: ["#01437d"],
	hAxis: {
				title: 'Travers Winners Last Track Raced 1991-2018',
...
// options - favs
	...
	hAxis: {
				title: 'Travers Favorites 1991-2018',
...
// options - running styles
	...
	hAxis: {
				title: 'Travers Winning Running Styles 1991-2018',
				titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12},
				textStyle: {color: '#888', fontSize: 12, fontName: 'verdana'},
				minValue: 0,
            	ticks: [0, .2, .4, .6, .8, 1]
...
// options - last out win/ITM
	...
	colors: ["#3a702e","#cccccc"],
	hAxis: {
				title: 'Travers Winners Finish Prior Race 1991-2018',
				titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12},
				textStyle: {color: '#888', fontSize: 12, fontName: 'verdana'},
				minValue: 0,
            	ticks: [0, .2, .4, .6, .8, 1]
