...
// data - age all starters
	...
	dataTable3.addRows([
		['',  6, 95, '36.1% 4 yos', 80, '30.4% 5 yos', 53, '20.2% 6yos', 20, '7.6% 7yos', 7, 2],
...
// data - age all starters by age group
	...
	dataTable4.addRows([
		['3-year-olds',  0, '', 6, '100%'],
		['4-year-olds',  13, '13.7%', 82, '86.3%'],
		['5-year-olds',  10, '12.8%', 70, '87.5%'],
		['6-year-olds',  2, '', 51, '96.2%'],
		['7-year-olds',  0, '', 20, '100%'],
		['8-year-olds',  1, '14.29', 6, '85.7%'],
		['9-year-olds',  0, '', 2, '100%'],
  ]);
...
// data - winning favs
	...
	dataTable5.addRows([
		...
		['',  7, '26.9% Winning Favs', 'Winning Favorites: 7', 19, '', 'Favorites not Winning: 19'],
		['',  17, '65.3% Favs ITM', 'Favorites In the Money (ITM): 19',  9, '', 'Favorites not In the Money (ITM): 9'],
  ]);
...
// data - runbacks
	...
	dataTable6.addRows([
		...
		['',  3, '6.9% Winning Run Backs', 'Winning Run Backs: 3', 40, '', 'Losing Run Backs: 40'],
		['',  13, '30.2% ITM Run Backs', 'ITM Run Backs: 13',  30, '', 'Run Backs Not ITM: 30'],
  ]);
...
// data - running styles
	...
	dataTable7.addColumn({type:'string', role:'annotation'});
	dataTable7.addRows([
		['',  6, '23% Deep Closer', 10, '38.4% Off the Pace', 6, '23% Stalker/Presser', 4, '15.3% Speed'],
  ]);
...
// data - prior race
	...
	dataTable8.addRows([
		...
		['',  7, '26.9% Won Prior Race', 'Won Prior Race: 7', 19, '', 'Lost Prior Race: 19'],
		['',  21, '80.8% In the Money Prior Race', 'In the Money Prior Race: 21',  5, '', 'Out of the Money Prior Race: 5'],
  ]);
...
// options - last track track
	...
	colors: ["#01437d"],
	hAxis: {
				title: 'Arlington Million Winners Last Track Raced 1991-2018',
...
// options - age
	...
	colors: ["#01437d"],
	hAxis: {
				title: 'Arlington Million Winners Age 1991-2018',
...
// options - age all starters
	...
	hAxis: {
				title: 'Arlington Million All Starters by Age 1991-2018',
				titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12},
...
// options - age starters by age group
	...
	hAxis: {
				title: 'Arlington Million Win Rate by Age 1991-2018',
				titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12},
...
// options - favs
	...
	colors: ["#3a702e","#cccccc"],
	hAxis: {
				title: 'Arlington Million Favorites 1991-2018',
				titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12},
				textStyle: {color: '#888', fontSize: 12, fontName: 'verdana'},
				minValue: 0,
            	ticks: [0, .2, .4, .6, .8, 1]
...
// options - runbacks
	...
	colors: ["#3a702e","#cccccc"],
	hAxis: {
				title: 'Arlington Million Run Backs 1991-2018',
				titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12},
				textStyle: {color: '#888', fontSize: 12, fontName: 'verdana'},
				minValue: 0,
            	ticks: [0, .2, .4, .6, .8, 1]
...
// options - running styles
	...
	hAxis: {
				title: 'Arlington Million Winning Running Styles 1991-2018',
				titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12},
				textStyle: {color: '#888', fontSize: 12, fontName: 'verdana'},
				minValue: 0,
            	ticks: [0, .2, .4, .6, .8, 1]
...
// options - last out win/ITM
	...
	colors: ["#3a702e","#cccccc"],
	hAxis: {
				title: 'Arlington Million Winners Finish Prior Race 1991-2018',
				titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12},
				textStyle: {color: '#888', fontSize: 12, fontName: 'verdana'},
				minValue: 0,
            	ticks: [0, .2, .4, .6, .8, 1]
