...
// data - age all starters
	...
	dataTable3.addRows([
		['',  89, '24.6% 3 yos', 122, '33.8% 4 yos', 104, '28.8% 5 yos', 33, '9.1% 6yos', 12, 1],
...
// data - age all starters by age group
	...
	dataTable4.addColumn({type:'string', role:'annotation'});
	dataTable4.addRows([
		['3-year-olds',  7, '7.8%', 82, '92.1%'],
		['4-year-olds',  11, '9.1%', 111, '90.9%'],
		['5-year-olds',  6, '5.9%', 98, '94.2%'],
		['6-year-olds',  3, '9.6%', 30, '90.9%'],
		['7-year-olds',  1, '9%', 11, '91.6%'],
		['8-year-olds',  0, '', 1, '100%'],
  ]);
...
// data - winning favs
	...
	dataTable5.addRows([
		...
		['',  10, '35.7% Winning Favs', 'Winning Favorites: 10', 17, '', 'Favorites not Winning: 18'],
...
// data - runbacks
	...
	dataTable6.addRows([
		...
		['',  5, '9% Winning Run Backs', 'Winning Run Backs: 5', 50, '', 'Losing Run Backs: 50'],
		['',  10, '18.2% ITM Run Backs', 'ITM Run Backs: 10',  45, '', 'Run Backs Not ITM: 45'],
  ]);
...
// data - running styles
	...
	dataTable7.addColumn({type:'string', role:'annotation'});
	dataTable7.addRows([
		['',  6, '21.4% Deep Closer', 6, '21.4% Off the Pace', 14, '50% Stalker/Presser', 2, '7.1% Speed'],
  ]);
...
// data - fillies mares in open company
	...
	dataTable9.addRows([
		...
		['',  6, '12.5% Winning Fillies/Mares', 'Winning Fillies/Mares: 6', 42, '', 'Fillies/Mares not Winning: 42'],
		['',  13, '27% Fillies/Mares ITM', 'Fillies/Mares In the Money (ITM): 13',  35, '', 'Fillies/Mares not In the Money (ITM): 35'],
  ]);
...
// options - last track track
	...
	colors: ["#01437d"],
	hAxis: {
				title: 'Breeders\'\ Cup Mile Winners Last Track Raced 1991-2017',
...
// options - age
	...
	colors: ["#01437d"],
		hAxis: {
				title: 'Breeders\'\ Cup Mile Winners Age 1991-2018',
...
// options - age all starters
	...
	hAxis: {
				title: 'Breeders\'\ Cup Mile All Starters by Age 1991-2018',
				titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12},
...
// options - age starters by age group
	...
	hAxis: {
				title: 'Breeders\'\ Cup Mile Win Rate by Age 1991-2018',
				titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12},
...
// options - favs
	...
	colors: ["#3a702e","#cccccc"],
	hAxis: {
				title: 'Breeders\'\ Cup Mile Favorites 1991-2018',
				titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12},
				textStyle: {color: '#888', fontSize: 12, fontName: 'verdana'},
				minValue: 0,
            	ticks: [0, .2, .4, .6, .8, 1]
...
// options - runbacks
	...
	colors: ["#3a702e","#cccccc"],
	hAxis: {
				title: 'Breeders\'\ Cup Mile Run Backs 1991-2018',
				titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12},
				textStyle: {color: '#888', fontSize: 12, fontName: 'verdana'},
				minValue: 0,
            	ticks: [0, .2, .4, .6, .8, 1]
...
// options - running styles
	...
	hAxis: {
				title: 'Breeders\'\ Cup Mile Winning Running Styles 1991-2018',
				titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12},
				textStyle: {color: '#888', fontSize: 12, fontName: 'verdana'},
				minValue: 0,
            	ticks: [0, .2, .4, .6, .8, 1]
...
// options - last out win/ITM
	...
	colors: ["#3a702e","#cccccc"],
	hAxis: {
				title: 'Breeders\'\ Cup Mile Winners Finish Prior Race 1991-2018',
				titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12},
				textStyle: {color: '#888', fontSize: 12, fontName: 'verdana'},
				minValue: 0,
            	ticks: [0, .2, .4, .6, .8, 1]
...
// options - fillies mares in open company
	...
	colors: ["#3a702e","#cccccc"],
hAxis: {
				title: 'Breeders\'\ Cup Mile Fillies and Mares 1991-2018',
				titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12},
				textStyle: {color: '#888', fontSize: 12, fontName: 'verdana'},
				minValue: 0,
            	ticks: [0, .2, .4, .6, .8, 1]
