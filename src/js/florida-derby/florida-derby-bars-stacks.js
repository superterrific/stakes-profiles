...
// data - winning favs
	...
	dataTable2.addRows([
		...
		['',  8, '27.5% Winning Favs', 'Winning Favorites: 8', 21, '', 'Favorites not Winning: 21'],
...
// data - running styles
	...
	dataTable3.addColumn({type:'string', role:'annotation'});
	dataTable3.addRows([
		['',  8, '27.5% Deep Closer', 2, '6.9% Off the Pace', 11, '37.9% Stalker/Presser', 8, '27.5% Speed'],
  ]);
...
// data - prior race
	...
	dataTable4.addRows([
		...
		['',  18, '62.1% Won Prior Race', 'Won Prior Race: 18', 11, '', 'Lost Prior Race: 11'],
		['',  27, '93.1% In the Money Prior Race', 'In the Money Prior Race: 27',  2, '', 'Out of the Money Prior Race: 2'],
  ]);
...
// options - last track track
	...
	colors: ["#01437d"],
	hAxis: {title: 'Florida Derby Winners Last Track Raced 1991-2019', titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12}, textStyle: {fontSize: 12, fontName: 'verdana'}, gridlines: {count: 10, color: '#dddddd'}},
...
// options - favs
	...
	hAxis: {title: 'Florida Derby Favorites 1991-2019', titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12}, textStyle: {fontSize: 12, fontName: 'verdana'}},
	vAxis: {textStyle: {fontSize: 12, fontName: 'verdana'}},
	bar: {groupWidth: "70%"},
...
// options - running styles
	...
	hAxis: {title: 'Florida Derby Winning Running Styles 1991-2019', titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12}, textStyle: {fontSize: 12, fontName: 'verdana'}},
	bar: {groupWidth: "45%"},
...
// options - last out win/ITM
	...
	legend: {position: 'none'},
	colors: ["#3a702e","#cccccc"],
	hAxis: {title: 'Florida Derby Winners Finish Prior Race 1991-2019', titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12}, textStyle: {fontSize: 12, fontName: 'verdana'}},
	bar: {groupWidth: "45%"},
	annotations: {textStyle: {fontName: 'verdana', fontSize: 11}},
