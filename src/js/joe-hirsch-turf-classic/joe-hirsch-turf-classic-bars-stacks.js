...
// data - age all starters
	...
	dataTable3.addColumn('number', '9 yos');
	dataTable3.addRows([
		['',  24, '12% 3 yos', 66, '33% 4 yos', 65, '32.5% 5 yos', 29, '14.5% 6yos', 13, 2, 1],
...
// data - age all starters by age group
	...
	dataTable4.addColumn({type:'string', role:'annotation'});
	dataTable4.addRows([
		['3-year-olds',  2, '8.3%', 22, ''],
		['4-year-olds',  11, '16.7%', 55, ''],
		['5-year-olds',  10, '15.3%', 54, ''],
		['6-year-olds',  1, '', 28, '96.5%'],
		['7-year-olds',  3, '23%', 10, ''],
		['8-year-olds',  0, '', 2, '100%'],
		['9-year-olds',  1, '100%', 0, ''],
  ]);
...
// data - winning favs
	...
	dataTable5.addRows([
		...
		['',  20, '75% Favs ITM', 'Favorites ITM: 20',  8, '', 'Favorites not ITM: 8'],
  ]);
...
// data - runbacks
	...
	dataTable6.addRows([
		...
		['',  8, '20% Winning Run Backs', 'Winning Run Backs: 8', 32, '', 'Losing Run Backs: 32'],
		['',  24, '60% ITM Run Backs', 'ITM Run Backs: 24',  16, '', 'Run Back Not ITM: 16'],
  ]);
...
// data - running styles
	...
	dataTable7.addColumn({type:'string', role:'annotation'});
	dataTable7.addColumn('number', 'Wire to Wire');
	dataTable7.addColumn({type:'string', role:'annotation'});
	dataTable7.addRows([
		['',  4, '14.2% Closer', 6, '21.4% Off the Pace', 10, '35.7% Stalker/Presser', 8, '28.5% Wire to Wire'],
  ]);
...
// data - prior race
	...
	dataTable8.addRows([
		...
		['',  13, '46.4% Won Prior Race', 'Won Prior Race: 13', 15, '', 'Lost Prior Race: 15'],
		['',  22, '78.6% In the Money Prior Race', 'In the Money Prior Race: 21',  6, '', 'Out of the Money Prior Race: 6'],
  ]);
...
// options - last track track
	...
	colors: ["#01437d"],
	hAxis: {
				title: 'Joe Hirsch Turf Classic Winners Last Track Raced 1991-2018',
...
// options - age
	...
	colors: ["#01437d"],
	hAxis: {
				title: 'Joe Hirsch Turf Classic Winners Age 1991-2018',
...
// options - age all starters
	...
	hAxis: {
				title: 'Joe Hirsch Turf Classic All Starters by Age 1991-2018',
				titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12},
...
// options - age starters by age group
	var options4 = {
	legend: {position: 'top', textStyle :{fontSize : 12, fontName: 'verdana'}},
	colors: ["#3a702e","#cccccc"],
	hAxis: {
				title: 'Joe Hirsch Turf Classic Win Rate by Age 1991-2018',
				titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12},
...
// options - favs
	...
	colors: ["#3a702e","#cccccc"],
hAxis: {
				title: 'Joe Hirsch Turf Classic Favorites 1991-2018',
				titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12},
				textStyle: {color: '#888', fontSize: 12, fontName: 'verdana'},
				minValue: 0,
            	ticks: [0, .2, .4, .6, .8, 1]
...
// options - runbacks
	...
	colors: ["#3a702e","#cccccc"],
hAxis: {
				title: 'Joe Hirsch Turf Classic Run Backs 1991-2018',
				titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12},
				textStyle: {color: '#888', fontSize: 12, fontName: 'verdana'},
				minValue: 0,
            	ticks: [0, .2, .4, .6, .8, 1]
...
// options - running styles
	...
	hAxis: {
				title: 'Joe Hirsch Turf Classic Winning Running Styles 1991-2018',
				titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12},
				textStyle: {color: '#888', fontSize: 12, fontName: 'verdana'},
				minValue: 0,
            	ticks: [0, .2, .4, .6, .8, 1]
...
// options - last out win/ITM
	...
	colors: ["#3a702e","#cccccc"],
	hAxis: {
				title: 'Joe Hirsch Turf Classic Winners Finish Prior Race 1991-2018',
				titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12},
				textStyle: {color: '#888', fontSize: 12, fontName: 'verdana'},
				minValue: 0,
            	ticks: [0, .2, .4, .6, .8, 1]
