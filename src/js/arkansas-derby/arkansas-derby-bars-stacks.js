...
// data - running styles
	...
	dataTable3.addColumn({type:'string', role:'annotation'});
	dataTable3.addRows([
		['',  7, '25% Deep Closer', 4, '14.2% Off the Pace', 10, '35.7% Stalker/Presser', 7, '25% Speed'],
  ]);
...
// data - prior race
	...
	dataTable4.addRows([
		...
		['',  14, '48.3% Won Prior Race', 'Won Prior Race: 14', 15, '', 'Lost Prior Race: 15'],
...
// options - last track track
	...
	colors: ["#01437d"],
	hAxis: {title: 'Arkansas Derby Winners Last Track Raced 1991-2019', titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12}, textStyle: {fontSize: 12, fontName: 'verdana'}, gridlines: {count: 14, color: '#dddddd'}},
...
// options - favs
	...
	hAxis: {title: 'Arkansas Derby Favorites 1991-2019', titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12}, textStyle: {fontSize: 12, fontName: 'verdana'}},
	vAxis: {textStyle: {fontSize: 12, fontName: 'verdana'}},
	bar: {groupWidth: "70%"},
...
// options - running styles
	...
	hAxis: {title: 'Arkansas Derby Winning Running Styles 1991-2019', titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12}, textStyle: {fontSize: 12, fontName: 'verdana'}},
	bar: {groupWidth: "45%"},
...
// options - last out win/ITM
	...
	legend: {position: 'none'},
	colors: ["#3a702e","#cccccc"],
	hAxis: {title: 'Arkansas Derby Winners Finish Prior Race 1991-2019', titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12}, textStyle: {fontSize: 12, fontName: 'verdana'}},
	bar: {groupWidth: "45%"},
	annotations: {textStyle: {fontName: 'verdana', fontSize: 11}},
