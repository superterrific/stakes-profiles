...
// data - winning favs
	...
	dataTable2.addRows([
		...
		['',  11, '39.3% Winning Favs', 'Winning Favorites: 11', 18, '', 'Favorites not Winning: 18'],
...
// data - running styles
	...
	dataTable3.addColumn({type:'string', role:'annotation'});
	dataTable3.addRows([
		['',  3, '10.3% Deep Closer', 5, '17.2% Off the Pace', 14, '48.2% Stalker/Presser', 7, '24.1% Speed'],
  ]);
...
// options - last track track
	...
	colors: ["#01437d"],
	hAxis: {title: 'Santa Anita Derby Winners Last Track Raced 1991-2019', titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12}, textStyle: {fontSize: 12, fontName: 'verdana'}, gridlines: {count: 10, color: '#dddddd'}},
...
// options - favs
	...
	hAxis: {title: 'Santa Anita Derby Favorites 1991-2019', titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12}, textStyle: {fontSize: 12, fontName: 'verdana'}},
	vAxis: {textStyle: {fontSize: 12, fontName: 'verdana'}},
	bar: {groupWidth: "70%"},
...
// options - running styles
	...
	hAxis: {title: 'Santa Anita Derby Winning Running Styles 1991-2019', titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12}, textStyle: {fontSize: 12, fontName: 'verdana'}},
	bar: {groupWidth: "45%"},
...
// options - last out win/ITM
	...
	legend: {position: 'none'},
	colors: ["#3a702e","#cccccc"],
	hAxis: {title: 'Santa Anita Derby Winners Finish Prior Race 1991-2019', titleTextStyle: {color: '#666', italic: 'false', fontName: 'verdana', fontSize: 12}, textStyle: {fontSize: 12, fontName: 'verdana'}},
	bar: {groupWidth: "45%"},
	annotations: {textStyle: {fontName: 'verdana', fontSize: 11}},
